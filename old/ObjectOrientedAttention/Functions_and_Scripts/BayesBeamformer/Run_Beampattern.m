addpath('/Users/Matthew/Documents/Robotics/iCubAudioAttention/MATLAB/ObjectOrientedAttention/Functions_and_Scripts/BayesBeamformer');

low_cf=100;high_cf=4000;numchans=100;

cfs = MakeErbCFs2(low_cf,high_cf,numchans);
