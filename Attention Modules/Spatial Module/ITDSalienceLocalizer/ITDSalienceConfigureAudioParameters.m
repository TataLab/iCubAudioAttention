...
P.fixedLag_samples =0;%P.frameDuration_samples;% P.frameDuration_samples;  %how much this process should lag the audio write process
P.c=340.29;%define speed of sound in m/s
P.D=0.1425; %define distance between microphones in m
P.ITDWindow=42;  %should be divisible by 2...this is how many samples to look on each side of the midline for a peak...this should be related to the distance between the microphones
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
%threshold detection
P.peakThreshold = 0.05;  %only adjust angle if signal exceeds this 
...
%%%%%%%%%%%%%%
P.attentionBeamBounds=[17 21]; %lags, this can preselect a region in space, set to NaNs if you want to search +/- 90 degs
