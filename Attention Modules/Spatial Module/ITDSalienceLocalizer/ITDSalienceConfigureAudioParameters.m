...
P.frameDuration_samples = 2*10240; %@48000 hz stereo 16-bit samples 2*10240 =  426 ms
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
%threshold detection
P.peakThreshold = 0.0 * 2^15;  %only adjust angle if peak sound level over the frame was greater than this...2^15 because the samples are coming in as signed 16-bit ints (but GetNextFrame casts them as doubles)
