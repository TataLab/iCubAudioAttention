...
/* ===========================================================================
 * @file  audioRunnerModule.cpp
 * @brief Implementation of the audioRunnerModule (see header file).
 * =========================================================================== */

#include <iCub/audioRunnerModule.h>

bool AudioRunnerModule::configure(yarp::os::ResourceFinder &rf) {
	 ...
	 * =========================================================================== */
	moduleName = rf.check("name", yarp::os::Value("/audioRunner"), "module name (string)").asString();
	 ...
	 * =========================================================================== */
	periodicThread = new AudioRunnerPeriodicThread(robotName, configFile);
...
bool AudioRunnerModule::interruptModule() {
	handlerPort.interrupt();
	return true;
}


bool AudioRunnerModule::close() {
...
bool AudioRunnerModule::respond(const yarp::os::Bottle& command, yarp::os::Bottle& reply) {
...
double AudioRunnerModule::getPeriod() {
	/* Module periodicity (seconds), called implicitly by myModule. */
	return 1;
}


bool AudioRunnerModule::updateModule() {
