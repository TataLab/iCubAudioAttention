...
/* ===========================================================================
 * @file  freqVisualisationModule.h
 * @brief Module for visualizing yarp matrices 
 *          (typically processed sound objects).
 * =========================================================================== */

#ifndef _FREQ_VISUALISATION_MODULE_H_
#define _FREQ_VISUALISATION_MODULE_H_
...
class FreqVisualisationModule : public yarp::os::RFModule {
  ...
  private:
    ...
    FreqVisualisationPeriodicThread *periodicThread;
...
#endif // _FREQ_VISUALISATION_MODULE_H_
