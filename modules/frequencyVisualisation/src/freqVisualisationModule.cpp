...
/* ===========================================================================
 * @file  freqVisualisationModule.cpp
 * @brief Implementation of the freqVisualisationModule (see header file).
 * =========================================================================== */

#include <iCub/freqVisualisationModule.h>

bool FreqVisualisationModule::configure(yarp::os::ResourceFinder &rf) {
	 ...
	 * =========================================================================== */
	moduleName = rf.check("name", yarp::os::Value("/frequencyVisualisation"), "module name (string)").asString();
	 ...
	 * =========================================================================== */
	periodicThread = new FreqVisualisationPeriodicThread(robotName, configFile);
...
bool FreqVisualisationModule::interruptModule() {
    handlerPort.interrupt();
    return true;
}


bool FreqVisualisationModule::close() {
...
bool FreqVisualisationModule::respond(const yarp::os::Bottle& command, yarp::os::Bottle& reply) {
...
double FreqVisualisationModule::getPeriod() {
	/* Module periodicity (seconds), called implicitly by myModule. */
	return 1;
}


bool FreqVisualisationModule::updateModule() {
