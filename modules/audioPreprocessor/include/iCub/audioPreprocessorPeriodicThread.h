...
private:
	...
	yMatrixBuffer outBeamformedWindowPort;
	...
	yMatrixBuffer outHilbertEnvelopeWindowPort;
	yMatrixBuffer outBandPassedEnvelopePort;
	yMatrixBuffer outBandPassedEnvelopeWindowPort;
	...
	yMatrix BeamformedWindowMatrix;
	...
	yMatrix HilbertEnvelopeWindowMatrix;
	yMatrix BandPassedEnvelopeMatrix;
	yMatrix BandPassedEnvelopeWindowMatrix;
