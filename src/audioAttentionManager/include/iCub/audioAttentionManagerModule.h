...
/**
 * @file audioAttentionManagerModule.h
 * @brief interface with speech recon
 */

#ifndef _AUDIO_ATTENTION_MANAGER_MODULE_H_
#define _AUDIO_ATTENTION_MANAGER_MODULE_H_
...
class audioAttentionManagerModule : public yarp::os::RFModule {
    ...
    /*  */
    audioAttentionManagerRatethread *rThread;// pointer to a new thread to be created and started in configure() and stopped in close()
...
#endif // _AUDIO_ATTENTION_MANAGER_MODULE_H_
