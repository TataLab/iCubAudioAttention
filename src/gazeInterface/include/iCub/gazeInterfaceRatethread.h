...
class gazeInterfaceRatethread : public yarp::os::RateThread {
private:
    ...
    yarp::os::Bottle* inputReading;                            // input image from the inputPort
    yarp::os::Bottle* outputCommand;                           // output image
...
public:
    ...
    * constructor default
    */
    gazeInterfaceRatethread();

    /**
    * constructor 
    * @param robotname name of the robot
    */
    gazeInterfaceRatethread(std::string robotname,std::string configFile);
...
#endif  //_GAZEINTERFACE_THREAD_H_
