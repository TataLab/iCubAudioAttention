...
/* ===========================================================================
 * @file  audioStreamerModule.cpp
 * @brief Implementation of the audioStreamerModule (see header file).
 * =========================================================================== */

#include <iCub/audioStreamerModule.h>

bool AudioStreamerModule::configure(yarp::os::ResourceFinder &rf) {
	 ...
	 * =========================================================================== */
	moduleName = rf.check("name", yarp::os::Value("/audioStreamer"), "module name (string)").asString();
	 ...
	 * =========================================================================== */
	periodicThread = new AudioStreamerPeriodicThread(robotName, configFile);
...
bool AudioStreamerModule::interruptModule() {
	handlerPort.interrupt();
	return true;
}


bool AudioStreamerModule::close() {
...
double AudioStreamerModule::getPeriod() {
	/* Module periodicity (seconds), called implicitly by myModule. */
	return 1;
}


bool AudioStreamerModule::updateModule() {
