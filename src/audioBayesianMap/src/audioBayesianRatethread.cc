...
bool AudioBayesianRatethread::threadInit()
{
  /*
    ...
    robot = rf.check("robot", Value("icub"),"Robot name (string)").asString();
...
bool AudioBayesianRatethread::updateModule()
{
...
bool AudioBayesianRatethread::interruptModule()
{
    fprintf(stderr, "[INFO] Calling close\n");
    return true;
}

bool AudioBayesianRatethread::close()
{
    fprintf(stderr, "[INFO] Calling close\n");
    return true;
}
